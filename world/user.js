...
function User () {
	...
	const _key = [
		12, 67, 89, 201, 21, 29, 178, 90, 10, 23, 89, 120, 2, 231, 152, 121, 43, 74, 23, 46, 152, 176, 23, 65, 89, 76
	];
	const _token = window["kot1"] || "";
	var __token = "";
	for (var i = 0 ; i < _token.length ; i++)
		__token += String.fromCharCode (_token[i] ^ _key[i + 1]);
